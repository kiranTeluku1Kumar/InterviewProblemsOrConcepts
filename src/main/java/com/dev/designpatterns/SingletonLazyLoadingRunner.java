...
public class SingletonLazyLoadingRunner {
	...
	public static void main(String[] args) throws InterruptedException {
		  ...
		  singletonLazyLoading2 = SingletonLazyLoading.getInstance(); //Here we can see both instances are having same hash code which will prove singleton design pattern 
